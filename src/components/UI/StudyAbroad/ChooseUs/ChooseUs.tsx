      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-3 mb-4">
            <div
              className={`p-3 rounded-2xl bg-linear-to-br from-blue-600 to-cyan-500 shadow-lg`}
            >
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-3xl md:text-4xl font-bold bg-linear-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
                {stat.value}
              </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                {/* Corner Decoration */}
                <div
                  className={`absolute top-0 right-0 w-24 h-24 bg-linear-to-bl ${feature.color} opacity-5 rounded-tr-2xl`}
                ></div>
              </div>
            </div>
          ))}
        ...
        <div data-aos="fade-up" className="mt-20 text-center">
          <div className="max-w-2xl mx-auto bg-linear-to-r from-blue-600 to-cyan-500 rounded-2xl p-8 md:p-12 shadow-2xl">
