...
const UniversityStats = () => {
  ...
  const badges: BadgeItem[] = [
    ...
    { name: "CSC Partner", color: "bg-green-100 text-green-800" },
    { name: "A+ Rating", color: "bg-purple-100 text-purple-800" },
  ];
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            ...
            your trusted partner for studying in China. Here&apos;s what makes
            us different.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {stats.map((stat, index) => (
            ...
            >
              <div className="absolute inset-0 bg-linear-to-br opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-500"></div>

              <div className="relative">
                <div
                  className={`mb-6 w-16 h-16 rounded-2xl bg-linear-to-br ${stat.color} flex items-center justify-center`}
                >
                ...
                <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="w-8 h-8 rounded-full bg-linear-to-br from-blue-100 to-purple-100 flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                {achievements.map((achievement, index) => (
                  <div key={index} className="relative pl-10">
                    <div className="absolute left-0 top-1 w-6 h-6 rounded-full bg-linear-to-r from-blue-500 to-purple-500 flex items-center justify-center">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 bg-linear-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center">
          ...
          <div className="mt-12 pt-8 border-t border-blue-200">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="px-8 py-3.5 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300">
