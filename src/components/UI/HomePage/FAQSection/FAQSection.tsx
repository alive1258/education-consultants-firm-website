...
const FAQSection = () => {
  ...
  return (
    <div className="relative py-20 bg-linear-to-b from-gray-50 to-white overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-3 gap-12">
                ...
                >
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {openIndex === index ? (
                        <FiChevronUp className="w-6 h-6 text-blue-600 shrink-0" />
                      ) : (
                        <FiChevronDown className="w-6 h-6 text-gray-400 shrink-0" />
                      )}
                    </div>
                  </button>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-8">
              ...
              {/* Download Brochure */}
              <div className="bg-linear-to-r from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100">
                ...
                <button className="w-full py-3.5 bg-linear-to-r from-emerald-500 to-teal-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-emerald-500/30 transition-all duration-300">
                  Download PDF Guide
                </button>
              </div>
            </div>
