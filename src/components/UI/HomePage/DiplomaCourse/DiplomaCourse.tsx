...
const DiplomaCourse = () => {
  ...
  useEffect(() => {
    // Mock data fetch - replace with your actual API endpoint
    const mockCourses: Course[] = [
      {
        ...
        sub_name: "CSE",
        sub_detail:
          "Comprehensive computer science diploma program focusing on programming, software development, and system analysis.",
      ...
      },
      {
        ...
        sub_name: "EEE",
        sub_detail:
          "Electrical engineering diploma covering power systems, electronics, and control systems.",
      ...
      },
      {
        ...
        sub_name: "CE",
        sub_detail:
          "Civil engineering diploma program focusing on structural design and construction management.",
      ...
      },
      {
        ...
        sub_name: "ME",
        sub_detail:
          "Mechanical engineering diploma covering design, manufacturing, and thermal systems.",
      ...
      },
      {
        ...
        sub_name: "SE",
        sub_detail:
          "Software engineering diploma focusing on modern development practices and methodologies.",
        image: "/images/course5.jpg",
        category: "diploma",
      },
      {
        id: 6,
        name: "Diploma in Industrial & Mechanical Engineering",
        sub_name: "IME",
        sub_detail:
          "Combined industrial and mechanical engineering diploma program.",
    ...
    // If you have a real API, use this instead:
    // fetch("/api/courses")
    //   .then((res) => res.json())
  ...
  return (
    <div className="relative py-20 md:py-32 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-linear-to-b from-white via-blue-50/20 to-white"></div>
      ...
      <div className="relative container px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-linear-to-r from-blue-50 to-cyan-50 rounded-full border border-blue-100 mb-6">
              <div className="flex items-center gap-1.5">
                <div className="w-2 h-2 bg-linear-to-r from-blue-500 to-cyan-400 rounded-full animate-pulse"></div>
                <div
                  className="w-2 h-2 bg-linear-to-r from-cyan-400 to-blue-500 rounded-full animate-pulse"
                  style={{ animationDelay: "0.3s" }}
                ></div>
                <div
                  className="w-2 h-2 bg-linear-to-r from-blue-500 to-cyan-400 rounded-full animate-pulse"
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="relative ml-4">
                <span className="relative z-10 bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-500 bg-clip-text text-transparent">
                  Diploma Courses
                </span>
                <div className="absolute -bottom-2 left-0 w-full h-2 bg-linear-to-r from-blue-100 via-cyan-100 to-emerald-100 rounded-full"></div>
              </span>
            </h1>
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="w-20 h-1 bg-linear-to-r from-transparent via-blue-500 to-transparent rounded-full"></div>
              <div className="flex items-center gap-3 px-5 py-2.5 bg-linear-to-r from-blue-50 to-cyan-50 rounded-full border border-blue-100 shadow-sm">
        ...
        <div className="mb-12 md:mb-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((highlight, i) => (
              <div
                key={i}
                className="group relative p-6 bg-linear-to-br from-white to-gray-50 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl hover:shadow-blue-100/30 transition-all duration-500 hover:-translate-y-2"
              >
                <div
              ...
              {filteredCourses.map((course) => (
                <div key={course.id} className="px-3">
                  <div className="relative group h-full">
                    ...
                    <div className="relative h-full bg-linear-to-br from-white via-white to-blue-50/30 rounded-2xl border border-gray-100 shadow-xl shadow-gray-100/50 hover:shadow-2xl hover:shadow-blue-100/30 transition-all duration-500 overflow-hidden group-hover:-translate-y-2">
                      {/* Course Image */}
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4">
                          <div className="px-3 py-1.5 bg-linear-to-r from-blue-500 to-cyan-500 rounded-full text-white text-sm font-semibold shadow-lg">
                            {course.sub_name}
                          </div>
                        </div>
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex gap-3">
                          <button className="flex-1 px-4 py-2.5 bg-linear-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:-translate-y-1">
                            Apply Now
                          </button>
                      ...
                      {/* Hover Effect Line */}
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-blue-500 via-cyan-500 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="mt-16">
          <div className="bg-linear-to-r from-blue-50 via-cyan-50 to-emerald-50 rounded-2xl p-8 md:p-12 border border-blue-100">
            <div className="grid md:grid-cols-2 gap-8">
              {/* Why Choose Diploma Programs */}
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-linear-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-linear-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="mt-10 pt-8 border-t border-blue-200 text-center">
              <button className="group px-8 py-4 bg-linear-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-500 hover:scale-105">
