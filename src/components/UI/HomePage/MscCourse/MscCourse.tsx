...
const MscCourse = () => {
    ...
    const mockCourses: Course[] = [
      {
        ...
        sub_name: "M.Sc. CS",
        description:
          "Advanced computer science program focusing on AI, machine learning, and data science.",
        image: "/images/msc-cs.jpg",
        category: "master",
        field: "computer",
      ...
      },
      {
        ...
        sub_name: "MBA",
        description:
          "Executive MBA program focusing on leadership, strategy, and business innovation.",
      ...
      {
        id: 3,
        name: "Master of Engineering in Electrical",
        sub_name: "M.Eng. EE",
        description:
          "Advanced electrical engineering program with focus on power systems and renewable energy.",
        image: "/images/meng-ee.jpg",
        category: "master",
        field: "engineering",
        program_type: "research",
        degree_level: "Postgraduate",
      ...
      },
      {
        ...
        sub_name: "M.Sc. DS",
        description:
          "Data science program covering machine learning, big data analytics, and statistical modeling.",
        image: "/images/msc-ds.jpg",
        category: "master",
        field: "computer",
        program_type: "professional",
        degree_level: "Postgraduate",
      ...
      },
      {
        ...
        sub_name: "MPH",
        description:
          "Public health program focusing on epidemiology, health policy, and global health.",
      ...
      },
      {
        ...
        sub_name: "M.Fin",
        description:
          "Finance program specializing in corporate finance, investment analysis, and risk management.",
        image: "/images/mfin.jpg",
        category: "master",
        field: "business",
        program_type: "professional",
        degree_level: "Postgraduate",
  ...
  const highlights: Highlight[] = [
    {
      icon: <AiOutlineCalendar className="w-8 h-8 text-emerald-600" />,
      title: "1-2 Years",
  ...
  return (
    <div className="relative py-20 md:py-32 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-linear-to-b from-white via-emerald-50/20 to-white"></div>
      ...
      <div className="relative container px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="text-center mb-12 md:mb-20">
          <div>
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-linear-to-r from-emerald-50 to-teal-50 rounded-full border border-emerald-100 mb-6">
              <div className="flex items-center gap-1.5">
                <div className="w-2 h-2 bg-linear-to-r from-emerald-500 to-teal-400 rounded-full animate-pulse"></div>
                <div
                  className="w-2 h-2 bg-linear-to-r from-teal-400 to-emerald-500 rounded-full animate-pulse"
                  style={{ animationDelay: "0.3s" }}
                ></div>
                <div
                  className="w-2 h-2 bg-linear-to-r from-emerald-500 to-teal-400 rounded-full animate-pulse"
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="relative ml-4">
                <span className="relative z-10 bg-linear-to-r from-emerald-600 via-teal-500 to-cyan-500 bg-clip-text text-transparent">
                  Degree Programs
                </span>
                <div className="absolute -bottom-2 left-0 w-full h-2 bg-linear-to-r from-emerald-100 via-teal-100 to-cyan-100 rounded-full"></div>
              </span>
            </h1>

            <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Advanced 1-2 year master&apos;s degree programs designed to
              provide specialized expertise, research skills, and leadership
              capabilities for career advancement and academic excellence
            </p>

            <div className="flex items-center justify-center gap-4">
              <div className="w-20 h-1 bg-linear-to-r from-transparent via-emerald-500 to-transparent rounded-full"></div>
              <div className="flex items-center gap-3 px-5 py-2.5 bg-linear-to-r from-emerald-50 to-teal-50 rounded-full border border-emerald-100 shadow-sm">
                <MdSchool className="w-6 h-6 text-emerald-600 animate-bounce" />
                <span className="font-semibold text-emerald-700">
                  Research-Intensive
                </span>
              </div>
              <div className="w-20 h-1 bg-linear-to-r from-transparent via-teal-500 to-transparent rounded-full"></div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12 md:mb-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((highlight, i) => (
              <div
                key={i}
                className="group relative p-6 bg-linear-to-br from-white to-gray-50 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl hover:shadow-emerald-100/30 transition-all duration-500 hover:-translate-y-2"
              >
                <div
              ...
              <button
                ...
                className={`group relative px-5 py-3 rounded-xl transition-all duration-300 flex items-center gap-3 ${
                  activeFilter === specialization.id
                    ? `bg-linear-to-r ${specialization.color} text-white shadow-lg shadow-emerald-500/30`
              ...
              {filteredCourses.map((course) => (
                <div key={course.id} className="px-3">
                  <div className="relative group h-full">
                    ...
                    <div className="relative h-full bg-linear-to-br from-white via-white to-emerald-50/30 rounded-2xl border border-gray-100 shadow-xl shadow-gray-100/50 hover:shadow-2xl hover:shadow-emerald-100/30 transition-all duration-500 overflow-hidden group-hover:-translate-y-2">
                      {/* Course Image */}
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4">
                          <div className="px-3 py-1.5 bg-linear-to-r from-emerald-500 to-teal-500 rounded-full text-white text-sm font-semibold shadow-lg">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex gap-3">
                          <button className="flex-1 px-4 py-2.5 bg-linear-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-emerald-500/30 transition-all duration-300 hover:-translate-y-1">
                            Apply Now
                          </button>
                      ...
                      {/* Hover Effect Line */}
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-emerald-500 via-teal-500 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div data-aos="fade-up" data-aos-delay="500" className="mt-16">
          <div className="bg-linear-to-r from-emerald-50 via-teal-50 to-cyan-50 rounded-2xl p-8 md:p-12 border border-emerald-100">
            <div className="grid md:grid-cols-2 gap-8">
              {/* Why Choose Master's Programs */}
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-linear-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-linear-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center shrink-0 mt-0.5">
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-linear-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/30">
            ...
            <div className="mt-10 pt-8 border-t border-emerald-200 text-center">
              <button className="group px-8 py-4 bg-linear-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-emerald-500/30 transition-all duration-500 hover:scale-105">
              ...
              <p className="text-gray-500 text-sm mt-4">
                Explore 30+ specialized master&apos;s programs with flexible
                study options
              </p>
            </div>
          </div>
