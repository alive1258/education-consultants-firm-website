        ...
        <div className="text-center mb-16 md:mb-24 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full border border-gray-100 shadow-sm mb-8">
            <div className="flex items-center gap-2">
              ...
              <div
                className="w-2 h-2 bg-linear-to-r from-cyan-400 to-emerald-400 rounded-full animate-pulse"
                style={{ animationDelay: "0.3s" }}
              ></div>
              <div
                className="w-2 h-2 bg-linear-to-r from-emerald-400 to-blue-500 rounded-full animate-pulse"
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-8">
            ...
            <span className="relative">
              <span className="relative bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-500 bg-clip-text text-transparent">
                Global Education
              </span>
              <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-48 h-1 bg-linear-to-r from-blue-500 via-cyan-400 to-emerald-400 rounded-full blur-sm"></div>
            </span>
          </h1>
          ...
          {statsData.map((stat) => (
            <div key={stat.id} className="relative group">
              ...
              >
                {/* Background Effect */}
                <div
                  className={`absolute inset-0 bg-linear-to-br ${stat.bgGradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                ></div>

                {/* Animated Border */}
                <div className="absolute inset-0 rounded-2xl p-px">
                  <div
                    className={`absolute inset-0 bg-linear-to-r ${stat.gradient} opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-500 rounded-2xl`}
                  ></div>
                </div>
                ...
                <div className="relative mb-8">
                  <div
                    className={`absolute -inset-4 bg-linear-to-r ${stat.gradient} rounded-full opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-500`}
                  ></div>
                  <div
                    className={`relative w-20 h-20 rounded-2xl bg-linear-to-br ${stat.gradient} flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-500`}
                  >
                ...
                <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="w-10 h-10 bg-linear-to-r from-gray-100 to-white rounded-full flex items-center justify-center shadow-md">
                    <svg
        ...
        <div className="mt-16 md:mt-24">
          <div className="text-center">
            <div className="inline-flex flex-wrap items-center justify-center gap-6 px-8 py-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-lg">
              ...
              <div className="w-px h-8 bg-linear-to-b from-transparent via-gray-300 to-transparent"></div>
