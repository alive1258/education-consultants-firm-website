...
//             <div className="w-3 h-12 bg-linear-to-b from-blue-500 to-cyan-400 rounded-full"></div>
//             <div className="w-3 h-12 bg-linear-to-b from-cyan-400 to-blue-400 rounded-full"></div>
//             <div className="w-3 h-12 bg-linear-to-b from-blue-400 to-blue-500 rounded-full"></div>
//           </div>
...
//                 China?
//               </span>
//               <div className="absolute -bottom-2 left-0 w-full h-2 bg-linear-to-r from-blue-100 to-cyan-100 rounded-full"></div>
//             </span>
//           </h1>
...
//             future through Chinas world-class education system and generous
//             scholarship programs
//           </p>

//           <div className="inline-flex items-center gap-3 px-6 py-3 bg-linear-to-r from-blue-50 to-cyan-50 rounded-full border border-blue-100 shadow-sm">
...
//               Global Academias Exclusive Partnership
//             </span>
//           </div>
//         </div>
...
//                                 {/* Background Effect */}
//                                 <div className="absolute inset-0 bg-linear-to-r opacity-0 group-hover/feature:opacity-100 transition-opacity duration-500"></div>
...
//                                   finish. Global Academias expertise made my
...
//               future with Chinas premium education system
//             </p>
...
import VisaSafety from "./VisaSafety";
