...
const Admission = () => {
  ...
  useEffect(() => {
    ...
    // Update every hour
    const timer = setInterval(calculateTimeLeft, 60 * 60 * 1000);
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-20 bg-linear-to-r from-blue-900 via-blue-800 to-indigo-900">
      {/* Background Elements */}
      <div className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-20"
          style={{
            backgroundImage: "url('/images/students-bg.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        />
        <div className="absolute top-0 right-0 w-64 h-64 bg-linear-to-br from-cyan-500/20 to-transparent rounded-full -translate-y-32 translate-x-32"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-linear-to-tr from-purple-500/10 to-transparent rounded-full translate-y-48 -translate-x-48"></div>
      </div>
      ...
      <div className="container relative mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* Deadline Timer */}
            <div className="bg-linear-to-r from-blue-600/30 to-cyan-600/30 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/30 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="mt-8 space-y-4">
                <Link href="/contact">
                  <button className="w-full bg-linear-to-r from-cyan-500 to-blue-600 text-white font-bold py-4 px-8 rounded-xl text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3">
                    Register Now
            ...
            {/* Contact Info */}
            <div className="bg-linear-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
        ...
        {/* Bottom Banner */}
        <div className="mt-16 bg-linear-to-r from-cyan-500/20 to-blue-500/20 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
