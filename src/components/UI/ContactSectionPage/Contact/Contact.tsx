...
import { PiGlobe, PiChatsTeardrop, PiUsersThree } from "react-icons/pi";

import contact from "../../../../../public/assets/image/contact1.avif";
...
const Contact = () => {
  ...
  const imageTags = ["Expert Guidance", "Quick Response", "Free Consultation"];

  return (
    <div className="relative py-20 md:py-28 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-linear-to-b from-gray-50 via-blue-50/20 to-white"></div>
      <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-blue-500 via-purple-500 to-cyan-500"></div>
      ...
      <div className="relative container px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Connect With
            <span className="block text-transparent bg-clip-text bg-linear-to-r from-blue-600 via-purple-600 to-cyan-600">
              Global Academia
            </span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-linear-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="relative group">
              <div className="absolute -inset-0.5 bg-linear-to-r from-blue-500 to-purple-500 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity"></div>
              <div className="relative overflow-hidden rounded-2xl">
                <Image
                  src={contact as StaticImageData}
            ...
            <div className="bg-linear-to-r mt-4 from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300">
                    <div className="flex items-start gap-4">
                      <div className={`p-3 rounded-xl ${info.bgColor}`}>
                        <div
                          className={`text-white bg-linear-to-br ${info.color} p-2 rounded-lg`}
                        >
                          {info.icon}
                        </div>
                      </div>
