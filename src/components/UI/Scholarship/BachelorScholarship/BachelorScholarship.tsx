...
// import sholarship2 from "../../../../../public/assets/scholarship2.avif";
        ...
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-20 relative ">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              ...
              <div className="relative group" data-aos="fade-right">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute top-6 left-6">
                    <div className="bg-linear-to-r from-blue-500 to-cyan-500 text-white px-4 py-2 rounded-full text-sm font-bold">
                      🎓 100% Tuition Free
                    </div>
                  </div>
                </div>
            ...
            <div data-aos="fade-left">
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Designed to empower and support bachelor&apos;s degree
                      students on their educational journey, easing the
              ...
              {/* CTA Button */}
              <button className="group w-full md:w-auto bg-linear-to-r from-blue-500 to-cyan-500 text-white font-bold py-4 px-8 rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-105 inline-flex items-center justify-center gap-3">
          ...
          <div className="mb-20" data-aos="fade-up">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className={`bg-linear-to-br ${benefit.gradient} border ${benefit.border} rounded-2xl p-6 group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer`}
                  data-aos="fade-up"
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            {/* Application Process */}
            <div
              className="bg-linear-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100"
              data-aos="fade-left"
            >
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-center gap-4">
                    <div className="shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center font-bold text-blue-600 text-lg">
                      {step.step}
                    </div>
                    <div>
              ...
              {/* Deadline Notice */}
              <div className="mt-8 p-4 bg-linear-to-r from-blue-500 to-cyan-500 rounded-xl text-white">
          ...
          <div className="mt-20 text-center" data-aos="fade-up">
            <div className="bg-linear-to-r from-blue-500 to-cyan-500 rounded-2xl p-12 text-white relative overflow-hidden">
              {/* Background pattern */}
