...
import { MdSchool, MdWork, MdBusinessCenter } from "react-icons/md";
...
const MasterScholarship = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-linear-to-br from-blue-50/30 via-white to-cyan-50/30"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-linear-to-br from-blue-100/20 to-cyan-100/20 rounded-full -translate-y-48 translate-x-48"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-linear-to-tr from-blue-100/10 to-cyan-100/10 rounded-full translate-y-64 -translate-x-64"></div>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 relative">
        {/* Header Section */}
        <div className="text-center max-w-4xl mx-auto mb-12">
          <div className="inline-flex items-center gap-3 mb-6">
            <div className="p-3 rounded-2xl bg-linear-to-br from-blue-600 to-cyan-500 shadow-lg">
              ...
              {tips.map((tip, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`
                      p-3 rounded-lg bg-linear-to-br ${tip.color}
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 rounded-lg bg-linear-to-br from-blue-600 to-cyan-500">
            ...
            {facilities.map((facility, index) => (
              ...
              >
                ...
                >
                  {/* Background Gradient */}
                  <div
                    className={`absolute inset-0 bg-linear-to-br ${facility.color} opacity-5 group-hover:opacity-10 transition-opacity duration-500`}
                  ></div>
                  ...
                  <div className="relative">
                    <div className="mb-6">
                      <div
                        ...
                        bg-linear-to-br ${facility.color}
                        shadow-lg
        ...
        <div data-aos="fade-up" className="text-center">
          <div className="max-w-4xl mx-auto bg-linear-to-r from-blue-600 to-cyan-500 rounded-3xl p-12 shadow-2xl">
