...
const DiplomaScholarship = () => {
  const scholarshipBenefits: ScholarshipBenefit[] = [
    {
  ...
  return (
    <div className="relative py-20 md:py-28 overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-linear-to-b from-gray-50 via-emerald-50/20 to-white"></div>
      <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-green-500 via-blue-500 to-purple-500"></div>
      ...
      <div className="relative container px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          <div className="inline-flex items-center gap-3 mb-6">
            <div className="relative">
              <div className="absolute -inset-1 bg-linear-to-r from-green-500 to-blue-500 rounded-full blur opacity-75"></div>
              <div className="relative p-3 bg-linear-to-r from-green-500 to-blue-500 rounded-full">
                <FaAward className="w-7 h-7 text-white" />
              </div>
            </div>
            <span className="text-sm font-semibold uppercase tracking-wider bg-linear-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Fully-Funded
            <span className="block text-transparent bg-clip-text bg-linear-to-r from-green-600 via-blue-500 to-purple-600">
              Diploma Education
            </span>
          </h1>
            ...
            >
              <div className="relative bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:border-green-200 transition-all duration-300">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-linear-to-br from-green-50 to-blue-50 flex items-center justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-8">
            ...
            {/* Additional Benefits */}
            <div className="bg-linear-to-r from-green-50 to-blue-50 rounded-2xl p-8 border border-green-100">
          ...
          <div className="space-y-8">
            ...
            <div className="relative group" data-aos="fade-left">
              <div className="absolute -inset-0.5 bg-linear-to-r from-green-500 to-blue-500 rounded-2xl blur opacity-30 group-hover:opacity-50 transition-opacity"></div>
                ...
                {scholarshipBenefits.map((benefit, index) => (
                  ...
                  >
                    <div className="relative p-5 rounded-xl border border-gray-200 hover:border-green-200 hover:shadow-lg transition-all duration-300">
                      <div
                        className={`mb-4 w-12 h-12 rounded-lg bg-linear-to-br ${benefit.color} flex items-center justify-center`}
                      >
                        {benefit.icon}
                      </div>
        ...
        <div className="relative rounded-2xl overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-r from-green-600/90 to-blue-600/90"></div>
