...
const TestPreparation = () => {
  ...
  const stats = [
    { value: "98%", label: "Success Rate", color: "text-blue-500" },
    { value: "1000+", label: "Students Trained", color: "text-green-500" },
  ];

  return (
    <section className="relative py-16 md:py-24 bg-linear-to-b from-white to-gray-50 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-linear-to-br from-blue-100 to-transparent rounded-full -translate-x-32 -translate-y-32 opacity-50"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-linear-to-tl from-green-100 to-transparent rounded-full translate-x-48 translate-y-48 opacity-30"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-left">
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10 border border-gray-100">
              ...
              {/* CTA */}
              <div className="mt-10">
                <button className="w-full py-4 bg-linear-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
