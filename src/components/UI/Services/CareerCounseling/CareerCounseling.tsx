...
const CareerCounseling = () => {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-linear-to-b from-gray-50 to-white overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-linear-to-br from-blue-50/30 via-transparent to-cyan-50/30"></div>
      <div className="absolute top-20 right-0 w-64 h-64 bg-linear-to-l from-purple-100 to-transparent rounded-full opacity-30 blur-3xl"></div>

      <div className="container mx-auto px-4 md:px-6 relative">
        {/* Header */}
        <div className="text-center max-w-4xl mx-auto mb-16" data-aos="fade-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-blue-100 to-cyan-100 rounded-full mb-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          {services.map((service, index) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-xl bg-linear-to-r ${service.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
              >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 bg-linear-to-r from-blue-100 to-cyan-100 rounded-full flex items-center justify-center">
          ...
          <div data-aos="fade-left">
            <div className="bg-linear-to-br from-blue-500 to-cyan-500 rounded-2xl p-8 md:p-10 text-white">
