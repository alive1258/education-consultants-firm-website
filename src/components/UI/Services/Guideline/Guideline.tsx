...
const Guideline = () => {
  ...
  const counselingFeatures: CounselingFeature[] = [
    {
  ...
  const stats = [
    { value: "1000+", label: "Students Guided", color: "text-blue-600" },
    { value: "95%", label: "Satisfaction Rate", color: "text-green-600" },
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            >
              ...
              <div className="space-y-4">
                {guidelines.map((item, index) => (
                  ...
                  >
                    <div
                      className={`${item.color} w-12 h-12 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300`}
                    >
                      {item.icon}
                    </div>
                    <div>
          ...
          <div className="space-y-6">
            ...
            >
              {/* <Image
                src={gideline as StaticImageData}
