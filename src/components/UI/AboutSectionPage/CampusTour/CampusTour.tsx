...
const CampusTour = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-linear-to-b from-gray-50 to-white">
      ...
      <div className="container px-4 md:px-6 py-16 md:py-24 relative">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Discover Our{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#09adfe] to-blue-600">
              Campus Life
            </span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6" data-aos="fade-right">
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-2xl group">
              {/* <Image
                src={images[0].src as StaticImageData}
                alt={images[0].alt}
                width={800}
          ...
          <div className="space-y-8" data-aos="fade-left">
            ...
            <div className="space-y-8">
              {/* Scholarship Section */}
              <div className="p-6 bg-linear-to-r from-[#09adfe] to-blue-500 rounded-2xl text-white">
        ...
        <div className="text-center mt-16" data-aos="fade-up">
          <button className="group relative px-8 py-4 bg-linear-to-r from-[#09adfe] to-blue-600 text-white font-semibold rounded-xl overflow-hidden">
            <span className="relative z-10">Schedule Your Campus Tour</span>
            <div className="absolute inset-0 bg-linear-to-r from-blue-600 to-[#09adfe] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
