...
const ProcessTimeline = () => {
  ...
  // Color mapping for dynamic classes (Tailwind needs explicit class names)
  ...
  // Solid background colors for step circles
    ...
    <section className="py-20 bg-linear-to-b from-white to-blue-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-linear-to-r from-blue-600 to-cyan-500 text-white px-6 py-2 rounded-full mb-6">
        ...
        <div className="relative">
          {/* Connecting Line */}
          <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 h-full w-1 bg-linear-to-b from-blue-400 via-cyan-400 to-indigo-400 hidden md:block"></div>

          {/* Steps */}
          <div className="space-y-12 md:space-y-0">
            {steps.map((step, index) => {
              const colors = colorClasses[step.color];
              const stepBgColor = stepBgColors[step.color];
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border-l-4 ${colors.border}`}
                    >
                      {/* Step Header */}
                      <div className="flex items-center gap-4 mb-4">
                        <div
                          className={`w-16 h-16 rounded-full ${colors.bg} flex items-center justify-center`}
                        >
                  ...
                  <div className="relative md:w-auto">
                    <div
                      className={`w-12 h-12 rounded-full ${stepBgColor} text-white flex items-center justify-center font-bold text-xl shadow-lg`}
                    >
                      {step.id}
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 bg-linear-to-r from-blue-600 to-cyan-500 text-white px-8 py-8 rounded-2xl">
