...
import { FaGraduationCap, FaUniversity, FaRegPaperPlane } from "react-icons/fa";
import { MdSchool, MdOutlineVerified } from "react-icons/md";

interface ScholarshipHighlight {
...
const AScholarship = () => {
  ...
  const [, setShowEligibilityForm] = useState(false);
  ...
  const scholarshipHighlights: ScholarshipHighlight[] = [
    {
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="block text-transparent bg-clip-text bg-linear-to-r from-gray-900 via-gray-700 to-gray-900">
              Generous Scholarships
            </span>
          </h1>

          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Access fully-funded educational opportunities in China&apos;s
            premier universities. We bridge the gap between talent and
            opportunity.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {eligibilityCriteria.map((criteria, index) => (
                  ...
                  >
                    <div className="w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center shrink-0 mt-0.5">
          ...
          <div className="space-y-6">
            ...
            {/* Quick Apply Card */}
            <div className="bg-linear-to-br from-gray-900 to-gray-800 rounded-2xl shadow-lg p-8 text-white">
              <div className="mb-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {applicationSteps.map((step, index) => (
              <div key={index} className="relative">
                ...
                {index < 3 && (
                  <div className="hidden md:block absolute top-8 -right-8 w-16 border-t-2 border-dashed border-gray-300"></div>
                )}
              </div>
            ))}
          </div>
